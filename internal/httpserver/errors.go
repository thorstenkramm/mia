...
const (
	...
	CodeUserAdministrationUnauthorized  Code = "user_administration_unauthorized"
...
var errorRegistry = map[Code]definition{
	...
	CodeUserAdministrationUnauthorized:  {http.StatusForbidden, "Unauthorized", "The request could not be completed."},
